...
<head>
	...
	<link rel="icon" href="img/logo_sd.png" type="image/x-icon">
...
<body>
	...
	<div align="center">
		...
		<br><br>
		<h1 class="jdl">PENDAFTARAN SEKOLAH SDN 2 KENANGA</h1>
		<br><br>
		...
		<div class="container">
			<div style="color:white">
				<h4>Login</h4>
				<br>
				<label>Login sebagai tamu :</label><br \>
				<label>Email: guest@guest.id | Password : guest</label><br \>
